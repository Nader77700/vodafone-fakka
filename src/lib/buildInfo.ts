...
export const BUILD_INFO = {
  ...
  bundleFile:     'VodafoneFakka-v3.0.333.apk',
  bundleHash:     'apk_v3.0.333_code333',
  apkHash:        'apk_v3.0.333_code333',
  dbVersion:      'v3.0.333',
  releaseNotes: [
    'v3.0.333: إصلاح حاسم لمشكلة الشاشة السوداء والإغلاق المفاجئ، وإصدار إجباري للجميع',
    'v3.0.333: إصلاح حاسم لمشكلة الشاشة السوداء (حدث خطأ غير متوقع) التي ظهرت بعد التحديث الأخير نتيجة تعارض في التشفير، وإصلاح توافقية مع هواتف أندرويد القديمة',

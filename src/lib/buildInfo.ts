...
export const BUILD_INFO = {
  ...
  bundleFile:     'VodafoneFakka-v3.0.330.apk',
  bundleHash:     'apk_v3.0.330_code330',
  apkHash:        'apk_v3.0.330_code330',
  dbVersion:      'v3.0.330',
  releaseNotes: [
    'v3.0.330: إصلاح حاسم لمشكلة الشاشة السوداء والإغلاق المفاجئ، وإصدار إجباري للجميع',
    'v3.0.330: إصلاح حاسم لمشكلة الشاشة السوداء (حدث خطأ غير متوقع) التي ظهرت بعد التحديث الأخير نتيجة تعارض في التشفير، وإصلاح توافقية مع هواتف أندرويد القديمة',

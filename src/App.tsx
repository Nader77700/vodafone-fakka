...
const ActivationPage         = lazyImport(() => import('./pages/ActivationPage'));
const RechargePage           = lazyImport(() => import('./pages/RechargePage'));
const FavoritesPage          = lazyImport(() => import('./pages/FavoritesPage'));
const OperationsPage         = lazyImport(() => import('./pages/OperationsPage'));
const UserOperationsPage     = lazyImport(() => import('./pages/UserOperationsPage'));
const OperationDetailPage    = lazyImport(() => import('./pages/OperationDetailPage'));
const NotificationsPage      = lazyImport(() => import('./pages/NotificationsPage'));
...
// ── Vodafone Cash Center ──────────────────────────────────────────────
const VodafoneCashCenter     = lazyImport(() => import('./pages/vodafone-cash/VodafoneCashCenter'));
const MoneyTransferPage      = lazyImport(() => import('./pages/vodafone-cash/MoneyTransferPage'));
...
const AdminFeatureManagement = lazyImport(() => import('./pages/admin/AdminFeatureManagement'));
const SecurityDashboard      = lazyImport(() => import('./pages/admin/SecurityDashboard'));
const CardFeedbackAdmin      = lazyImport(() => import('./pages/admin/CardFeedbackAdmin'));
const AdminMerchantDetail    = lazyImport(() => import('./pages/admin/AdminMerchantDetail'));
const AdminDuplicateAccounts = lazyImport(() => import('./pages/admin/AdminDuplicateAccounts'));
...
const InvitePage             = lazyImport(() => import('./pages/InvitePage'));
const StatisticsPage         = lazyImport(() => import('./pages/StatisticsPage'));
const SubscriptionHistoryPage = lazyImport(() => import('./pages/SubscriptionHistoryPage'));
const SubscriptionDetailPage = lazyImport(() => import('./pages/SubscriptionDetailPage'));
const BuildInfoPage          = lazyImport(() => import('./pages/BuildInfoPage'));
const UpdatesPage            = lazyImport(() => import('./pages/UpdatesPage'));
const SystemLogsPage         = lazyImport(() => import('./pages/SystemLogsPage'));
const NetworksPage           = lazyImport(() => import('./pages/NetworksPage'));
const VodafonePage           = lazyImport(() => import('./pages/networks/VodafonePage'));
const OrangePage             = lazyImport(() => import('./pages/networks/OrangePage'));
const EtisalatPage           = lazyImport(() => import('./pages/networks/EtisalatPage'));
const WEPage                 = lazyImport(() => import('./pages/networks/WEPage'));
const ESimPage               = lazyImport(() => import('./pages/networks/ESimPage'));
const ESimDetailPage         = lazyImport(() => import('./pages/networks/ESimDetailPage'));
    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/" element={<RouteGuard><MerchantClientGate /></RouteGuard>}>
          ...
          {/* ── Vodafone Cash Center ─────────────────────────────────────────── */}
          <Route path="vodafone-cash-center"                  element={<PageErrorBoundary pageName="vcc-main"><S><VodafoneCashCenter /></S></PageErrorBoundary>} />
          <Route path="vodafone-cash-center/transfer"         element={<PageErrorBoundary pageName="vcc-transfer"><S><MoneyTransferPage /></S></PageErrorBoundary>} />

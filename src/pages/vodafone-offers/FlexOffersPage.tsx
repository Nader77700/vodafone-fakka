      ...
      <div className="space-y-4">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-16 gap-3 rounded-[18px]"
            ...
            <p className="text-[12px] text-muted-foreground">جاري تحميل عروض فليكس...</p>
          </div>
        ) : error ? (
          ...
          <div className="flex flex-col items-center gap-4 py-14 rounded-[18px]"
            ...
            <div className="text-center px-4">
              <p className="text-sm font-black text-muted-foreground mb-1">لا توجد عروض فليكس متاحة</p>
              <p className="text-[11px] text-muted-foreground leading-relaxed">لا توجد عروض فليكس متاحة حالياً</p>
            </div>
          </div>
        ) : (

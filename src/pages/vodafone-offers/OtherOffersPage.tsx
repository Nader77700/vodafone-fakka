      ...
      <div className="space-y-4">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-16 gap-3 rounded-[18px]"
            ...
            <p className="text-[12px] text-white/35">جاري تحميل العروض...</p>
          </div>
        ) : error ? (
          ...
          <div className="flex flex-col items-center gap-4 py-14 rounded-[18px]"
            ...
            <div className="text-center px-4">
              <p className="text-sm font-black text-white/60 mb-1">لا توجد عروض أخرى متاحة</p>
              <p className="text-[11px] text-white/30 leading-relaxed">لا توجد عروض متنوعة متاحة حالياً</p>
            </div>
          </div>
        ) : (

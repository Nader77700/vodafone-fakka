    ...
    <div className="min-h-screen bg-background pb-24 font-cairo selection:bg-[#E60000]/30 selection:text-white">
      ...
      <div className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border">
        <div className="flex items-center justify-between px-4 h-16">
          ...
          <div className="flex-1 text-center">
            <h1 className="text-[17px] font-bold tracking-wide">سجل شحن الرصيد</h1>
      ...
      <div className="px-4 pt-6 space-y-4">
        ...
        <div className="flex gap-2">
          ...
          <button className="bg-card border border-border p-2.5 rounded-xl text-white/70 hover:text-white hover:border-primary/50 transition-colors">
        ...
        <div className="space-y-3">
          {history.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 text-center space-y-3 opacity-60">
              ...
              <p className="text-sm font-medium">لا توجد عمليات شحن مسجلة بعد</p>
            </div>
          ) : (
            history.map((op) => (

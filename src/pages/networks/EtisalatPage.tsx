// صفحة Etisalat — تفاصيل الشبكة وخدماتها
...
const NETWORK = {
  ...
  nameAr: 'اتصالات',
  color: '#00AA00',
  description: 'شبكة اتصالات المتحدة مصر — جودة عالية وتغطية واسعة وخدمات رقمية متكاملة.',
  logo: '🟢',
};
  ...
  return (
    <div className="min-h-screen pb-6 page-enter" dir="rtl"
      ...
      <div className="relative overflow-hidden rounded-b-3xl mb-4"
        style={{
          background: L
            ? 'linear-gradient(135deg,rgba(0,170,0,0.07),rgba(255,255,255,0.95))'
            : 'linear-gradient(135deg,rgba(0,170,0,0.18),rgba(0,130,0,0.08),rgba(0,0,0,0.80))',
          borderBottom: '1.5px solid rgba(0,170,0,0.25)',
        }}>
        <div className="absolute inset-0 pointer-events-none"
          style={{ background: 'radial-gradient(ellipse 80% 60% at 20% 50%,rgba(0,170,0,0.10),transparent)' }} />
        <div className="relative px-4 pt-5 pb-6">
          ...
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl font-black"
              style={{ background: 'linear-gradient(135deg,rgba(0,170,0,0.20),rgba(0,130,0,0.12))', border: '2px solid rgba(0,170,0,0.35)' }}>
              {NETWORK.logo}
            </div>
            <div>
      ...
      <div className="px-4 space-y-3">
        ...
        <div className="rounded-2xl p-5 text-center space-y-3"
          style={{ background: 'rgba(0,170,0,0.06)', border: '1.5px solid rgba(0,170,0,0.20)' }}>
      ...
      <div className="px-4 pt-5">
        <Button className="w-full h-11 font-bold gap-2"
          style={{ background: 'linear-gradient(90deg,#00AA00,#008800)' }}
          onClick={() => navigate('/networks')}>
          <ChevronRight className="w-4 h-4" />
          العودة للشبكات
        </Button>

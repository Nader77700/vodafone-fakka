// صفحة Vodafone — تفاصيل الشبكة وخدماتها
import { useNavigate } from 'react-router-dom';
import { ChevronRight, Radio, Zap, Clock, Smartphone, Wifi, CreditCard, Package, Star, PhoneCall } from 'lucide-react';
...
const NETWORK = {
  ...
  description: 'أكبر شبكة اتصالات في مصر. تقديم أفضل الخدمات من فكة ودقائق وإنترنت وباقات متنوعة للأفراد والشركات.',
  logo: '🔴',
};
  ...
  return (
    <div className="min-h-screen pb-6 page-enter" dir="rtl">
      ...
      <div className="relative overflow-hidden rounded-b-3xl mb-4"
        style={{ background: 'linear-gradient(135deg,rgba(230,0,0,0.18),rgba(180,0,0,0.08),rgba(0,0,0,0.80))', borderBottom: '1.5px solid rgba(230,0,0,0.25)' }}>
        <div className="absolute inset-0 pointer-events-none"
          style={{ background: 'radial-gradient(ellipse 80% 60% at 20% 50%,rgba(230,0,0,0.12),transparent)' }} />
        <div className="relative px-4 pt-5 pb-6">
          ...
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl font-black"
              style={{ background: 'linear-gradient(135deg,rgba(230,0,0,0.25),rgba(180,0,0,0.15))', border: '2px solid rgba(230,0,0,0.40)' }}>
              {NETWORK.logo}
            </div>
            <div>
      ...
      <div className="px-4 space-y-3">
        ...
        <div className="rounded-2xl p-5 text-center space-y-3"
          style={{ background: 'rgba(230,0,0,0.06)', border: '1.5px solid rgba(230,0,0,0.20)' }}>

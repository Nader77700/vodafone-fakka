  ...
  return (
    <div className="min-h-screen pb-6 page-enter" dir="rtl">
      ...
      <div className="relative overflow-hidden rounded-b-3xl mb-4"
        style={{ background: 'linear-gradient(135deg,rgba(255,102,0,0.18),rgba(200,80,0,0.08),rgba(0,0,0,0.80))', borderBottom: `1.5px solid rgba(255,102,0,0.25)` }}>
        <div className="absolute inset-0 pointer-events-none"
          style={{ background: 'radial-gradient(ellipse 80% 60% at 20% 50%,rgba(255,102,0,0.12),transparent)' }} />
        <div className="relative px-4 pt-5 pb-6">
          ...
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl font-black"
              style={{ background: 'linear-gradient(135deg,rgba(255,102,0,0.25),rgba(200,80,0,0.15))', border: '2px solid rgba(255,102,0,0.40)' }}>
              {NETWORK.logo}
            </div>
            <div>

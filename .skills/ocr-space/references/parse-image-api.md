...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-ck2v94t1nev5-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image` |
...
async function ocrParseImage(params: {
  ...
  const response = await fetch("https://app-ck2v94t1nev5-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
    method: "POST",
    headers: {
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- Call upstream ---
  const upstream = await fetch("https://app-ck2v94t1nev5-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
    method: "POST",
    headers: {

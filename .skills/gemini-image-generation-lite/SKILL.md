...
| Item | Value |
|------|-------|
| Endpoint | `POST https://app-ck2v94t1nev5-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent` |
...
// POST to: https://app-ck2v94t1nev5-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent

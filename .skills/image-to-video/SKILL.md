...
| Item | Details |
|------|---------|
| Submit endpoint | `POST https://app-ck2v94t1nev5-api-rY7JZvg0dqdL.gateway.appmedo.com/v1/videos/image2video` |
| Query endpoint | `GET https://app-ck2v94t1nev5-api-oYA6Z8wDBRDa.gateway.appmedo.com/v1/videos/image2video/{id}` |

...
**Endpoint:** `GET https://app-ck2v94t1nev5-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-ck2v94t1nev5-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,

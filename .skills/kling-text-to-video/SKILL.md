...
| Property | Value |
|----------|-------|
| Submit Endpoint | `POST https://app-ck2v94t1nev5-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video` |
| Query Endpoint | `GET https://app-ck2v94t1nev5-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/{id}` |

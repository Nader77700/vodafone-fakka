...
BEGIN
  ...
  INSERT INTO subscriptions (
    user_id, license_key_id, status, code_type, duration_days, days_remaining,
    ops_limit, ops_remaining, expires_at, created_at, updated_at
  ) VALUES (
    p_user_id, v_key.id, 'active'::public.subscription_status, v_key.code_type, v_effective_days, v_effective_days,
